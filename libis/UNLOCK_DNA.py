...
from .prixfixe.unlockdna import UnlockDNACoreBlock, UnlockDNAFinalLayersBlock, UnlockDNAFirstLayersBlock
...
class UNLOCK_DNA_Wrapper(pl.LightningModule):
    def __init__(self,
        hparams: dict = dict(
            lr = 1e-4,
            wd = 1e-4,
        ...
        first = UnlockDNAFirstLayersBlock()
        core = UnlockDNACoreBlock()

        final = UnlockDNAFinalLayersBlock()
